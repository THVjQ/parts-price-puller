...
(function () {
  ...
  function buildPanel() {
    ...
    el.innerHTML = `
      <style>
        #ppp-panel{position:fixed;bottom:16px;right:16px;z-index:999999;background:#16213e;color:#e0e0e0;
          font:12px/1.5 monospace;border:1px solid #0f3460;border-radius:8px;width:250px;
          box-shadow:0 4px 20px rgba(0,0,0,.5)}
        #ppp-panel .hd{padding:6px 10px;background:#0f3460;border-radius:8px 8px 0 0;cursor:pointer;
          font-weight:bold;display:flex;justify-content:space-between}
        #ppp-panel .bd{padding:10px;display:none}
        #ppp-panel.open .bd{display:block}
      ...
      <div class="hd"><span>💰 Price Puller v${SCRIPT_VERSION}</span><span>▾</span></div>
      <div class="bd">
